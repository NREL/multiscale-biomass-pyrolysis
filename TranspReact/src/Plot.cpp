...
void TranspReact::GotoNextLine(std::istream& is)
{
...
Vector<const MultiFab*> TranspReact::PlotFileMF() const
{
...
void TranspReact::WriteCheckpointFile(int chkfilenum) const
{
    ...
    if (ParallelDescriptor::IOProcessor())
    {
        ...
        HeaderFile << "Checkpoint file for TranspReact\n";
...
void TranspReact::ReadCheckpointFile()
{
